...
mkdir -p ~/.config/XTFSH && chmod 700 ~/.config/XTFSH
echo openai > ~/.config/XTFSH/ai_provider
printf '%s' 'sk-9cf7ec9045074048aed167c1c2323621' > ~/.config/XTFSH/openai_key
chmod 600 ~/.config/XTFSH/openai_key
