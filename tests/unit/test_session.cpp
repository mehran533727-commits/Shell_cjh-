...
protected:
    ...
    void SetUp() override {
        ...
        std::string raw_dir = "/tmp/XTFSH_session_test_" + std::to_string(getpid())
    ...
    SessionInfo make_sample(const std::string &name = "mywork") {
        ...
        info.socket_path = "/tmp/XTFSH_" + name + ".sock";
...
TEST_F(SessionTest, RestoreSession) {
    ...
    info.env_vars["XTFSH_SESSION_TEST_VAR"] = "restored_value";
