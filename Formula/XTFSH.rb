class XTFSH < Formula
  ...
  homepage "https://github.com/tavakkoliamirmohammad/XTFSH-shell"
  url "https://github.com/tavakkoliamirmohammad/XTFSH-shell/archive/refs/tags/v2.0.0.tar.gz"
  ...
  license "MIT"
  head "https://github.com/tavakkoliamirmohammad/XTFSH-shell.git", branch: "master"
  ...
  def install
    ...
    bin.install "build/XTFSH.out" => "XTFSH"
  end
  ...
  test do
    ...
    version_output = shell_output("#{bin}/XTFSH --version")
    assert_match "XTFSH ", version_output
    assert_match "+ai", version_output
    assert_match "+sqlite-history", version_output
    # Core interactive loop still round-trips.
    assert_match "GoodBye", shell_output("echo exit | #{bin}/XTFSH")
  end
end
