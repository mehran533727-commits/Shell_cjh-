class CJHSH < Formula
  ...
  homepage "https://github.com/tavakkoliamirmohammad/CJHSH-shell"
  url "https://github.com/tavakkoliamirmohammad/CJHSH-shell/archive/refs/tags/v2.0.0.tar.gz"
  ...
  license "MIT"
  head "https://github.com/tavakkoliamirmohammad/CJHSH-shell.git", branch: "master"
  ...
  def install
    ...
    bin.install "build/CJHSH.out" => "CJHSH"
  end
  ...
  test do
    ...
    version_output = shell_output("#{bin}/CJHSH --version")
    assert_match "CJHSH ", version_output
    assert_match "+ai", version_output
    assert_match "+sqlite-history", version_output
    # Core interactive loop still round-trips.
    assert_match "GoodBye", shell_output("echo exit | #{bin}/CJHSH")
  end
end
