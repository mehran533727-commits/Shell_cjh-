#ifndef CJHSH_UTIL_IO_H
#define CJHSH_UTIL_IO_H

// Unified diagnostic I/O for CJHSH.
//
// Previously every TU called write_stderr() with an ad-hoc "CJHSH: ..."
...
//     CJHSH_LOG_LEVEL env var, silently drops anything below the threshold);
