#ifndef CJHSH_UTIL_LIMITS_H
#define CJHSH_UTIL_LIMITS_H
...
inline constexpr std::size_t CJHSH_MAX_EXPANSION_BYTES = 1 * 1024 * 1024;
...
// nothing.
inline constexpr std::size_t CJHSH_MAX_GLOB_RESULTS = 10000;
...
inline constexpr std::size_t CJHSH_MAX_HEREDOC_BYTES = 100ULL * 1024 * 1024;

} // namespace CJHSH::util

#endif // CJHSH_UTIL_LIMITS_H
