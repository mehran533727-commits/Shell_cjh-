#ifndef CJHSH_AI_LLM_DIAGNOSTICS_H
#define CJHSH_AI_LLM_DIAGNOSTICS_H
...
// OpenAI and Ollama. The functions emit via the shared CJHSH::io facility:
//   * transient, retryable failures use CJHSH::io::warning;
//   * final failures (after retries exhausted, or non-retryable statuses)
//     use CJHSH::io::error;
//   * request/response traces are gated behind CJHSH_LOG_LEVEL=debug.
//
...
#endif // CJHSH_AI_LLM_DIAGNOSTICS_H
