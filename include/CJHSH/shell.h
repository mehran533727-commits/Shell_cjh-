#ifndef CJHSH_SHELL_H
#define CJHSH_SHELL_H
...
struct CoreState {
    ...
    int next_background_job_id = 1;
    std::unordered_map<pid_t, BackgroundJob> background_processes;
};
...
// declaration in include/CJHSH/core/signals.h — keeping both copies here
