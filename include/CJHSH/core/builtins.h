#ifndef CJHSH_CORE_BUILTINS_H
#define CJHSH_CORE_BUILTINS_H

// Builtin registry surface. The per-builtin function declarations live
// in `CJHSH/builtins.h`; this header only exposes the registry lookup
// helpers that the executor uses to decide whether a command is a
// builtin. Split out of the old mega-header CJHSH/core.h.
