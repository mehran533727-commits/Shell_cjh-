#ifndef CJHSH_CORE_SIGNALS_H
#define CJHSH_CORE_SIGNALS_H

// Signal-handler globals, trap plumbing, and the process-wide fatal
// exit helper. Split out of the old mega-header CJHSH/core.h.
// `CJHSH/core.h` still includes this so existing #include paths keep
// working.
