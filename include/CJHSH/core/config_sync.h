#ifndef CJHSH_CORE_CONFIG_SYNC_H
#define CJHSH_CORE_CONFIG_SYNC_H

#include <string>
#include <vector>

namespace CJHSH::config_sync {
...
/// Returns ~/.CJHSH/, creates the directory if it does not exist.
std::string get_CJHSH_config_dir();
...
#endif // CJHSH_CORE_CONFIG_SYNC_H
