#ifndef CJHSH_CORE_SESSION_H
#define CJHSH_CORE_SESSION_H
...
// Returns ~/.CJHSH/sessions/, creating the directory if needed.
...
// Check whether ~/.CJHSH/sessions/<name>.json exists.
