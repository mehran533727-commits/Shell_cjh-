#ifndef CJHSH_FIG_COMPLETION_PROVIDER_H
#define CJHSH_FIG_COMPLETION_PROVIDER_H
...
public:
    // Construct with default spec directory (~/.CJHSH/completions/fig/)
...
#endif // CJHSH_FIG_COMPLETION_PROVIDER_H
