#ifndef CJHSH_SQLITE_HISTORY_PROVIDER_H
#define CJHSH_SQLITE_HISTORY_PROVIDER_H
...
public:
    ...
    // If db_path is empty, defaults to ~/.CJHSH/history.db.
...
#endif // CJHSH_SQLITE_HISTORY_PROVIDER_H
