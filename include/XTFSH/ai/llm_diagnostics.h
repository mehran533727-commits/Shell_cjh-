#ifndef XTFSH_AI_LLM_DIAGNOSTICS_H
#define XTFSH_AI_LLM_DIAGNOSTICS_H
...
// OpenAI and Ollama. The functions emit via the shared XTFSH::io facility:
//   * transient, retryable failures use XTFSH::io::warning;
//   * final failures (after retries exhausted, or non-retryable statuses)
//     use XTFSH::io::error;
//   * request/response traces are gated behind XTFSH_LOG_LEVEL=debug.
//
...
#endif // XTFSH_AI_LLM_DIAGNOSTICS_H
