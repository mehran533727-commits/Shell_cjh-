#ifndef XTFSH_CORE_SIGNALS_H
#define XTFSH_CORE_SIGNALS_H

// Signal-handler globals, trap plumbing, and the process-wide fatal
// exit helper. Split out of the old mega-header XTFSH/core.h.
// `XTFSH/core.h` still includes this so existing #include paths keep
// working.
