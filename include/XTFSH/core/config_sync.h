#ifndef XTFSH_CORE_CONFIG_SYNC_H
#define XTFSH_CORE_CONFIG_SYNC_H

#include <string>
#include <vector>

namespace XTFSH::config_sync {
...
/// Returns ~/.XTFSH/, creates the directory if it does not exist.
std::string get_XTFSH_config_dir();
...
#endif // XTFSH_CORE_CONFIG_SYNC_H
