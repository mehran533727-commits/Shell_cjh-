#ifndef XTFSH_CORE_EXECUTOR_H
#define XTFSH_CORE_EXECUTOR_H
...
// live in XTFSH/shell.h since the state struct needs to see them too.
//
// Split out of the old mega-header XTFSH/core.h. `XTFSH/core.h` still
