#ifndef XTFSH_CORE_SESSION_H
#define XTFSH_CORE_SESSION_H
...
// Returns ~/.XTFSH/sessions/, creating the directory if needed.
...
// Check whether ~/.XTFSH/sessions/<name>.json exists.
