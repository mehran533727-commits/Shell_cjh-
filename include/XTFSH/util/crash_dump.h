#ifndef XTFSH_UTIL_CRASH_DUMP_H
#define XTFSH_UTIL_CRASH_DUMP_H

// Async-signal-safe crash-dump handler for XTFSH.
//
...
// no std::cerr, no XTFSH::io::error, no locks.
