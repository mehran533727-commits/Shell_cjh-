#ifndef XTFSH_UTIL_CONFIG_FILE_H
#define XTFSH_UTIL_CONFIG_FILE_H

// Minimal user-config loader for ~/.XTFSH/config.json.
//
...
//     from XTFSH::config::get_data_dir() (defaults to $HOME/.XTFSH).
//   - XTFSH_LOG_LEVEL, when set and non-empty, overrides `log_level`.
...
// XTFSH_LOG_LEVEL env override, and return the resulting config.
UserConfig load();
...
#endif // XTFSH_UTIL_CONFIG_FILE_H
