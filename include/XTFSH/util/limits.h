#ifndef XTFSH_UTIL_LIMITS_H
#define XTFSH_UTIL_LIMITS_H
...
inline constexpr std::size_t XTFSH_MAX_EXPANSION_BYTES = 1 * 1024 * 1024;
...
// nothing.
inline constexpr std::size_t XTFSH_MAX_GLOB_RESULTS = 10000;
...
inline constexpr std::size_t XTFSH_MAX_HEREDOC_BYTES = 100ULL * 1024 * 1024;

} // namespace XTFSH::util

#endif // XTFSH_UTIL_LIMITS_H
