#ifndef XTFSH_UTIL_IO_H
#define XTFSH_UTIL_IO_H

// Unified diagnostic I/O for XTFSH.
//
// Previously every TU called write_stderr() with an ad-hoc "XTFSH: ..."
...
//     XTFSH_LOG_LEVEL env var, silently drops anything below the threshold);
