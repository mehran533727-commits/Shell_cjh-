#ifndef XTFSH_SQLITE_HISTORY_PROVIDER_H
#define XTFSH_SQLITE_HISTORY_PROVIDER_H
...
public:
    ...
    // If db_path is empty, defaults to ~/.XTFSH/history.db.
...
#endif // XTFSH_SQLITE_HISTORY_PROVIDER_H
