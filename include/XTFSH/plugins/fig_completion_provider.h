#ifndef XTFSH_FIG_COMPLETION_PROVIDER_H
#define XTFSH_FIG_COMPLETION_PROVIDER_H
...
public:
    // Construct with default spec directory (~/.XTFSH/completions/fig/)
...
#endif // XTFSH_FIG_COMPLETION_PROVIDER_H
